                      ...
                      <div class="row">
                        <div class="col-md-12 text-xs-center">
                          <div class="m-y-3 table-responsive">
                            ...
                            <p class="lead pi-draggable pi-item" draggable="true">頁數: <?php echo($page)?>/<?php echo( floor($cownumber/10));?></p>
                            <button onclick="location.href='./more?page=<?php echo( ($page-1));?>'" class="btn btn-primary">上一頁</button>
                            <button onclick="location.href='./more?page=<?php echo( ($page+1));?>'" class="btn btn-primary">下一頁</button>                            
                          </div>
                        </div>
                      </div>
                    </div>
